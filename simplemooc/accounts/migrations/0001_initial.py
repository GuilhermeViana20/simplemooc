# Generated by Django 4.2.21 on 2025-05-29 13:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surname', models.CharField(blank=True, max_length=30, verbose_name='Sobrenome')),
                ('is_active', models.BooleanField(blank=True, default=True, verbose_name='Ativo')),
                ('is_staff', models.BooleanField(blank=True, default=False, verbose_name='Membro da Equipe')),
                ('date_joined', models.DateTimeField(auto_now_add=True, verbose_name='Data de Registro')),
                ('image', models.ImageField(blank=True, null=True, upload_to='users/%Y/%m/%d', verbose_name='Imagem')),
